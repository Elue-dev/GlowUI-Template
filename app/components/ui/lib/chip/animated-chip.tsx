...
import { AnimatedChipProps } from "./chip.types";
      ...
      <Animated.View style={[styles.chip, animatedContainerStyle]}>
        <Animated.View style={[animatedIconOpacityStyle]}>
          {/* <SymbolView
            ...
            tintColor={isActive ? activeTextColor : "#AAAAAA"}
          /> */}
          <Feather
            name={isActive && activeIcon ? activeIcon : icon}
            size={18}
            color={isActive ? activeTextColor : "#AAAAAA"}
          />
        </Animated.View>
        {isActive && (
          <Animated.View>
            <Animated.View style={[styles.labelWrapper, animatedTextStyle]}>
              <Animated.Text style={[styles.label, { color: activeTextColor }]}>
                {label}
              </Animated.Text>
            </Animated.View>
          </Animated.View>
